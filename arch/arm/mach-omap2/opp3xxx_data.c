...
struct omap_volt_data omap36xx_vddmpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP2G_UV, OMAP3630_SR_MPU_DEFAULT_MARGIN_2G, OMAP3630_CONTROL_FUSE_OPP2G_VDD1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
